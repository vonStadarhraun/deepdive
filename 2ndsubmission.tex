...
\begin{abstract}
Data from seven data storage tags recovered from Atlantic salmon were analyzed for depth movements and patterns of deep diving during the marine stay. 
The salmon mostly stayed at the surface and showed diurnal activity negatively related to day length especially from autumn until spring. 
...
Most of dives were short, ($<5$ hours) but up to 33 hours. 
...
The causes of diel movements and deep diving observed in this study may be a result of several driving forces including thermo-regulation, predator avoidance, optimal feeding and foraging behavior.
...
a AR1 structure with parameter $\theta$. The R-code for this is available (see Code \ref{code1}).}
